Um programa que faz a leitura de N contribuintes(fornecido pelo usuário), podendo ser pessoa física ou jurídica. Os dados de pessoa física são: nome, renda anual e gastos com saúde. Os dados de pessoa jurídica
são nome, renda anual e número de funcionários. 

As regras para o cálculo de imposto são as seguintes:
